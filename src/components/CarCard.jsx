      ...
      <div className='p-4 sm:p-5'>
        <div className='flex justify-between items-start mb-2'>
          ...
          <div className='mt-4 grid grid-cols-2 gap-y-2 text-grey-600'>
                <div className='flex items-center text-sm text-sm text-muted-foreground'>
                  <img src={assets.users_icon} alt="usericon" className='h-4 mr-2'/>
                  <span>{car.seating_capacity} Seats</span>
                </div>
                <div className='flex items-center text-sm text-sm text-muted-foreground'>
                  <img src={assets.fuel_icon_icon} alt="usericon" className='h-4 mr-2'/>
                ...
                <div className='flex items-center text-sm text-sm text-muted-foreground'>
                  <img src={assets.location_iconn} alt="usericon" className='h-4 mr-2'/>
