  ...
  return (
    ...
    <footer className="bg-black text-white py-12 px-6 md:px-12 lg:px-24">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Main Footer Content */}
        <div className="flex flex-wrap items-start gap-5 md:gap-10 lg:gap-12 mb-12">
          
          {/* Logo and Brand */}
          <div className="w-full md:w-auto">
            <Link to="/" className="inline-block">
            <img src={assets.logo} alt="footer" className='w-30'/>
              <span className="block mt-2 text-xl font-bold">CarBooking</span>
            </Link>
            <p className="mt-4 text-gray-400 max-w-xs">
              Premium car booking service for your comfortable journey.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/cars" className="text-gray-400 hover:text-white transition">Cars</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/company" className="text-gray-400 hover:text-white transition">Company</Link></li>
              ...
              <li>
                <Link to="/careers" className="text-gray-400 hover:text-white transition">
                  Careers
                  <span className="text-xs bg-blue-600 text-white rounded-md ml-2 px-2 py-1">We're hiring!</span>
                </Link>
              </li>
            </ul>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">
            © 2025 CarBooking. All rights reserved.
          </p>
