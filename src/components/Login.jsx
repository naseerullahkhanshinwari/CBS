    ...
    return (
        <div onClick={() => setShowLogin(false)} className='fixed top-0 bottom-0 left-0 right-0 z-100 flex items-center justify-center text-sm text-gray-600 bg-black/50'>
            <form onSubmit={handleSubmit} onClick={(e) => e.stopPropagation()} className="sm:w-[350px] w-full text-center border border-gray-300/60 rounded-2xl px-8 bg-white">
                ...
                {state !== "login" && (
                    <div className="flex items-center mt-6 w-full bg-white border border-borderColor h-12 rounded-full overflow-hidden pl-6 gap-2">
                ...
                <div className="flex items-center w-full mt-4 bg-white border border-borderColor h-12 rounded-full overflow-hidden pl-6 gap-2">
                ...
                <div className="flex items-center mt-4 w-full bg-white border border-borderColor h-12 rounded-full overflow-hidden pl-6 gap-2">
