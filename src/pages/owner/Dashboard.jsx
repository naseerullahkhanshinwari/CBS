...
const Dashboard = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-1'>
      <Title title="Admin Dashboard" subtitle="Manage all cars like Add New Car, Bookings, revenue and Activities" />
      ...
      <div className='flex gap-10'>
            ...
            <div key={index} className='mt-4 flex items-center justify-between'>
              <div className='flex items-center gap-2'>
                ...
                <div>
                  ...
                  <p className='text-sm text-black'>{booking.createdAt.split('T')[0]}</p>
                </div>
                <div className='flex items-center gap-60 font-medium'>
        ...
        <div className='p-4 md:p-6 mb-6 border border-borderColor rounded-md w-full md:max-w-xs'>
          <h1 className='text-lg font-medium'>Monthly Income</h1>
          <p className='text-gray-500'>Income of the current Month</p>
